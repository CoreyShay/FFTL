...
#if !defined(_DURANGO)
	sm_TicksToUsScalar = 1000000.0 / f64(freq.QuadPart << 10); // On my machine, QPC actually right shifts CPU cycles by 10, so this may work.
#else
	sm_TicksToUsScalar = 1000000.0 / f64(freq.QuadPart);
#endif
}
