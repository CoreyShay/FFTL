...
#	endif
#elif defined(__ORBIS__) && !defined(FFTL_THREAD_USE_POSIX)
#	include <pthread.h>
...
enum enThreadPriority { kThreadPriorityLowest, kThreadPriorityVeryLow, kThreadPriorityLow, kThreadPriorityNormal, kThreadPriorityHigh, kThreadPriorityVeryHigh, kThreadPriorityHighest };
...
ThreadId CreateAndStartThread(ThreadHandle* outThreadHandle, FFTL_THREAD_RETURNTYPE (FFTL_THREAD_CALLCONV *pFunc)(void*), void* pParam = nullptr, enThreadPriority priority = kThreadPriorityNormal, uint coreAffinityMask = 0, const char* pszName = nullptr, u32 stackSize = 0);
...
public:
	...
	void Start(ThreadOwner* pOwner, const char* pszName = nullptr, enThreadPriority priority = kThreadPriorityNormal, uint coreAffinityMask = 0, u32 stackSize = 0);
