...
inline ThreadId CreateAndStartThread(ThreadHandle* outThreadHandle, FFTL_THREAD_RETURNTYPE (FFTL_THREAD_CALLCONV *pFunc)(void*), void* pParam, enThreadPriority priority, uint coreAffinityMask, const char* pszName, u32 stackSize)
{
	...
	switch (priority)
	{
	case kThreadPriorityLowest:		osPriority = THREAD_BASE_PRIORITY_IDLE;		break;
	case kThreadPriorityVeryLow:	osPriority = THREAD_PRIORITY_LOWEST;		break;
	case kThreadPriorityLow:		osPriority = THREAD_PRIORITY_BELOW_NORMAL;	break;
	case kThreadPriorityNormal:		osPriority = THREAD_PRIORITY_NORMAL;		break;
	case kThreadPriorityHigh:		osPriority = THREAD_PRIORITY_ABOVE_NORMAL;	break;
	case kThreadPriorityVeryHigh:	osPriority = THREAD_PRIORITY_HIGHEST;		break;
	case kThreadPriorityHighest:	osPriority = THREAD_PRIORITY_TIME_CRITICAL;	break;
