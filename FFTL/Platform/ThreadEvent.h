...
#if defined(__ORBIS__) && !defined(FFTL_THREAD_USE_POSIX)
...
inline bool ThreadEvent::Wait(u32 timeOut_mS)
{
	...
	FFTL_VERIFY_MSG( WAIT_FAILED != result, "ThreadEvent::Wait() : WaitForSingleObject failed!" );
...
inline bool ThreadEvent::Wait(u32 timeOut_mS)
{
	...
	FFTL_ASSERT_MSG( 0 == result, "ThreadEvent::Wait() : sem_wait failed!" );
