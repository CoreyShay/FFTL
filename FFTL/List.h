...
//	const T* GetNextElement() const { return m_pNextNode && m_pNextNode->m_pNextNode ? m_pNextNode->GetElement() : nullptr; }
//	T* GetNextElement() { return m_pNextNode && m_pNextNode->m_pNextNode ? m_pNextNode->GetElement() : nullptr; }
//	const T* GetPrevElement() const { return m_pPrevNode && m_pPrevNode->m_pPrevNode ? m_pPrevNode->GetElement() : nullptr; }
//	T* GetPrevElement() { return m_pPrevNode && m_pPrevNode->m_pPrevNode ? m_pPrevNode->GetElement() : nullptr; }
...
//	const ListNode<T, Tag>* begin() const { return GetHead(); }
//	const ListNode<T, Tag>* end() const { return &m_TailSentinel; }
